...
import com.example.admindeskboard.databinding.FragmentFirstBinding;
...
public class First_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
                ...
                new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                String url = "https://testserverleo.000webhostapp.com/apps/DemoUploadData.php?ti=" + title + "&de=" + descrioption + "&im=" + imagelink;
        ...
        binding.wantToShow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fragment = new FirstViewFragment();
