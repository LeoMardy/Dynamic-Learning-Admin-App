...
import com.example.admindeskboard.databinding.FragmentThiredBinding;
import com.example.admindeskboard.databinding.FragmentThiredViewBinding;
...
public class Thired_View_Fragment extends Fragment {

    FragmentThiredViewBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentThiredViewBinding.inflate(getLayoutInflater(), container, false);
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.binding.UpdateButtonID.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putString("id_key_three", id);
                    Fragment fragment = new UpdateFragment_Three();
                ...
                public void onClick(View view) {
                    ...
                    new AlertDialog.Builder(getActivity())
                            ...
                            .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    String url = "https://testserverleo.000webhostapp.com/apps/DemoDeleteDataThree.php?id=" + id;
    ...
    public void loadData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, response -> {
            ...
            binding.thiredRvView.setLayoutManager(layoutManager);
            binding.thiredRvView.setAdapter(myAdapter);
