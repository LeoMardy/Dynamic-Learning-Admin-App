...
public class Thired_Fragment extends Fragment {

    FragmentThiredBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentThiredBinding.inflate(getLayoutInflater(), container, false);
                ...
                new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                String url = "https://testserverleo.000webhostapp.com/apps/DemoUploadDataThree.php?ti=" + title + "&de=" + descrioption + "&im=" + imagelink;
        ...
        binding.wantToShow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fragment = new Thired_View_Fragment();
